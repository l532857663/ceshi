...
class syn_Report{
		...
		public function sql_info($query){
				$conn = mysqli_connect("127.0.0.1","root","123456","wifilz");
...
$myF = fopen("./synReport.txt","w+");
$fwrite($myF,$strHTML);
fclose($myF);
//				$queryINTO = "INSERT INTO `".$this->mac_sign."wifilz_syn_report` (report_text,report_data) VALUES ('".$strHTML."','".$strA."')";
//		var_dump($queryINTO);
