...
var hbase_table_name = "dxy:15093191339"
...
func main(){
		...
		for row_num, row := range rows {
				...
				cmd_str += base64.StdEncoding.EncodeToString ([]byte (strconv.FormatInt (get_time.Unix () - get_time.Unix () % 600, 10)))

				cmd_str += "\"><Cell column=\""

				cmd_str += "aW5mbzppbmZv"
